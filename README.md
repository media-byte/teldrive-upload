...
WORKERS=4 # Number of current workers to use when uploading multi-part of a big file, increase this to attain higher speeds with large files (4 is default)
```
